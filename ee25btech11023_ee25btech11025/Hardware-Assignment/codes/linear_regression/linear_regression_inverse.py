...
y_train, x_train = np.loadtxt('training_data.txt', unpack=True)

y_val, x_val = np.loadtxt('validation_data.txt', unpack=True)
...
plt.legend()
plt.grid(True)
plt.savefig("../../figs/temp_voltage/train.png")
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig("../../figs/temp_voltage/valid.png")
plt.show()
