...
{\hypersetup{colorlinks=false, urlbordercolor={0 0 1}}\url{https://github.com/PuniAditya/EE1030-2025-Project-Submissions/blob/main/ee25btech11046_ee25btech11062/Hardware-Assignment/codes/arduino/code.cpp}}.
...
\begin{table}[!h]
  ...
  \input{tables/validation_results.tex}
\end{table}
